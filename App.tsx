...
const translations = {
    en: {
        ...
        'clutter.results.savedItemsTitle': 'Saved Items',
        'clutter.results.removeItem': 'Remove item',
    ...
    ru: {
        ...
        'clutter.results.savedItemsTitle': 'Сохраненные предметы',
        'clutter.results.removeItem': 'Удалить предмет',
